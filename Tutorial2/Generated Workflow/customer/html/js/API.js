...
function  isBlackBerry6NonTouchScreen() {
    if (isBlackBerry() && navigator.userAgent.match(/Version\/6./i)) {
        var ua = navigator.userAgent;
        if ((ua.indexOf('9780') > 0) || (ua.indexOf('9700') > 0) || (ua.indexOf('9650') > 0)) {
            return true;
        }
    }
    return false;
...
function showUrlInBrowser(url)
{
    ...
    if (isWindowsMobile()) {
        ...
        if ( isIOS() && !(typeof iScroller === "undefined") &&  iScroller ){ //CR#700698-1
